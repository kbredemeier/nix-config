...
in
{
  ...
  sops = {
    # This is the location of the host specific age-key for the user "kb" and will to have been extracted to this location via hosts/common/core/sops.nix on the host
